...
const bool PGRParams::outputInfo(const int &info_level){
  ...
  std::cout << line_start << "min depth:   " << std::to_string(min_depth) << std::endl;
  std::cout << line_start << "max depth:   " << std::to_string(max_depth) << std::endl;
  std::cout << line_start << "width_k:     " << std::to_string(width_k) << std::endl;
  std::cout << line_start << "width_min:   " << std::to_string(width_min) << std::endl;
  std::cout << line_start << "width_max:   " << std::to_string(width_max) << std::endl;
  std::cout << line_start << "alpha:       " << std::to_string(alpha) << std::endl;
  std::cout << line_start << "---------Settings---------" << std::endl;
  return true;
}
